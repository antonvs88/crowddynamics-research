...
class RoomEvacuation(MultiAgentSimulation):
    def __init__(self, queue, size, width, height, model, body, spawn_shape,
        ...
        #
        # JATKA TÄSTÄ...
        # TÄÄ ON PIKEMMINKIN OBSTACLES
        #exteriors = MultiLineString([((width, (height - door_width) / 2), (width, 0), (0, 0), (0, height), \
        #                              (width, height), (width, (height + door_width) / 2)), ((width, height), \
        #                              (2 * width, height), (2 * width, 0), (width, 0))])
        wall_width = 0
        ...
        #obstacles = (self.room1 | self.room2).exterior - exits
